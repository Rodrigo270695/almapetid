    ...
    */
    ...
    'custom' => [
        'document_number' => [
            ...
            'regex' => 'El número de documento no tiene un formato válido.',
        ],
        'email' => [
            'unique' => 'Este correo electrónico ya está registrado.',
        ],
        'ruc' => [
            'unique' => 'Ya existe una veterinaria registrada con este RUC.',
            'regex' => 'El RUC debe tener exactamente 11 dígitos.',
        ],
        'chip.microchip' => [
            'unique' => 'Este microchip ya está registrado.',
            'regex' => 'El microchip debe tener exactamente 15 dígitos.',
        ],
    ],
    ...
    'attributes' => [
        ...
        'ruc' => 'RUC',
        'organization_name' => 'razón social',
        'address' => 'dirección',
        'contact_phone' => 'teléfono',
        'owner.document_type' => 'tipo de documento del propietario',
        'owner.document_number' => 'número de documento del propietario',
        'owner.name' => 'nombres del propietario',
        'owner.lastname' => 'apellidos del propietario',
