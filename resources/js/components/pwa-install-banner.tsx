...
const DISMISS_KEY = 'almapetid-pwa-install-dismiss-until';
...
const appLabel = import.meta.env.VITE_APP_NAME || 'AlmaPet ID';
    ...
    return (
        ...
        >
            <div className="mx-auto flex max-w-lg items-start gap-3">
                <div
                    className="mt-0.5 flex size-9 shrink-0 items-center justify-center rounded-xl text-[#007598]"
                ...
                <div className="min-w-0 flex-1">
                    {showChromiumInstall ? (
                        <>
                            ...
                            <button
                                type="button"
                                className="mt-2 inline-flex h-9 items-center justify-center rounded-lg bg-[#007598] px-4 text-sm font-medium text-white shadow-sm transition-colors hover:bg-[#006480] focus-visible:ring-2 focus-visible:ring-[#007598]/40 focus-visible:outline-none disabled:opacity-60"
                ...
                <button
                    type="button"
                    className="-mt-1 -mr-1 flex size-9 shrink-0 items-center justify-center rounded-lg text-muted-foreground transition-colors hover:bg-muted hover:text-foreground focus-visible:ring-2 focus-visible:ring-[#007598]/30 focus-visible:outline-none"
                    onClick={onDismiss}
