 ...
 *  - Los roles del sistema (owner, clinic_staff, org_admin, platform_admin) NO se editan/eliminan
...
export default function Index({
    ...
    setLayoutProps({
        breadcrumbs: [
            ...
            { title: 'Roles', href: '/platform/roles' },
        ],
    });
    ...
    const {
        ...
        storageKey: 'almapetid.roles.prefs',
        defaults: {
            ...
            },
            {
                ...
                cell: (role) => (
                    <div className="flex items-center gap-1.5">
                        <KeyRound
                            className="size-3.5 shrink-0 text-brand-sky/70"
                            strokeWidth={2.25}
                        />
